...
- (void)setupViewControllers {
    ...
    homeNav.tabBarItem = [[UITabBarItem alloc] initWithTitle:nil image:[self resizeTabBarImage:homeDefaultImage] selectedImage:[self resizeTabBarImage:homeSelectedImage]];
    ...
    hotNav.tabBarItem = [[UITabBarItem alloc] initWithTitle:nil image:[self resizeTabBarImage:hotDefaultImage] selectedImage:[self resizeTabBarImage:hotSelectedImage]];
    ...
    subNav.tabBarItem = [[UITabBarItem alloc] initWithTitle:nil image:[self resizeTabBarImage:subDefaultImage] selectedImage:[self resizeTabBarImage:subSelectedImage]];
    ...
    profileNav.tabBarItem = [[UITabBarItem alloc] initWithTitle:nil image:[self resizeTabBarImage:mineDefaultImage] selectedImage:[self resizeTabBarImage:mineSelectedImage]];
